document.addEventListener('DOMContentLoaded', function() {
    ...
    const translationsURL = "https://raw.githubusercontent.com/ChatHeritage/Sestiere_di_Dorsoduro/main/translations.json"; // URL del file JSON delle traduzioni
    ...
    var map = L.map('map').setView([45.433349, 12.327476], 14);
    ...
    var southWest = L.latLng( 45.429886, 12.324557),
        northEast = L.latLng(45.434441, 12.337668);
    ...
    markers.push(L.marker([45.433404, 12.32618], {
        icon: selectedIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.430245, 12.326227], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.4315518538569, 12.328239977359774], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.430375423305115, 12.331523001194002], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.43099846397975, 12.33469605445862], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.43089117347764, 12.335586547851564], {
        icon: defaultIcon
    }).addTo(map));
    ...
    markers.push(L.marker([45.43094764218839, 12.337088584899902], {
        icon: defaultIcon
    }).addTo(map));
